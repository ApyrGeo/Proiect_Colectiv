...
namespace TrackForUBB.Repository.Migrations
{
    ...
    [Migration("20260104145444_MakeSubjectSemesterDependent")]
    partial class MakeSubjectSemesterDependent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContractSubject", b =>
                {
                    ...
                    b.HasKey("ContractsId", "SubjectsId");

                    b.HasIndex("SubjectsId");

                    b.ToTable("ContractSubject");
                });
            ...
            modelBuilder.Entity("TrackForUBB.Repository.EFEntities.Contract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TrackForUBB.Repository.EFEntities.ExamEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TrackForUBB.Repository.EFEntities.Subject", b =>
                {
                    ...
                    b.Property<string>("SubjectCodeId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TrackForUBB.Repository.EFEntities.SubjectCode", b =>
                {
            ...
            modelBuilder.Entity("ContractSubject", b =>
                {
                    b.HasOne("TrackForUBB.Repository.EFEntities.Contract", null)
                        .WithMany()
                        .HasForeignKey("ContractsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TrackForUBB.Repository.EFEntities.Subject", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TrackForUBB.Repository.EFEntities.Subject", b =>
                {
                    ...
                    b.HasOne("TrackForUBB.Repository.EFEntities.SubjectCode", null)
                        .WithMany("Subjects")
