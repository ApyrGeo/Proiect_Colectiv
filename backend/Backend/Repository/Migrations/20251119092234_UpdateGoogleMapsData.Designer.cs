...
namespace Repository.Migrations
{
    ...
    [Migration("20251119092234_UpdateGoogleMapsData")]
    partial class UpdateGoogleMapsData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.GroupYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Hour", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Enrollment", b =>
                {
                    b.HasOne("Domain.StudentSubGroup", "SubGroup")
            ...
            modelBuilder.Entity("Domain.GroupYear", b =>
                {
                    b.HasOne("Domain.Specialisation", "Specialisation")
                        .WithMany("GroupYears")
            ...
            modelBuilder.Entity("Domain.Hour", b =>
                {
                    ...
                    b.HasOne("Domain.GroupYear", "GroupYear")
                        .WithMany()
                        .HasForeignKey("GroupYearId");

                    b.HasOne("Domain.StudentGroup", "StudentGroup")
                        .WithMany()
                        .HasForeignKey("StudentGroupId");

                    b.HasOne("Domain.StudentSubGroup", "StudentSubGroup")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Location", b =>
                {
                    b.OwnsOne("Domain.GoogleMapsData", "GoogleMapsData", b1 =>
                        {
