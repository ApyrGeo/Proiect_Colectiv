...
public interface IGradeService
{
    ...
    Task<List<GradeResponseDTO>> GetGradesFiteredAsync(int userId, int? yearOfStudy, int? semester, int? specialisationId);
    Task<GradeResponseDTO> GetGradeByIdAsync(int gradeId);
    Task<ScholarshipStatusDTO?> GetUserAverageScoreAndScholarshipStatusAsync(int userId, int year, int semester, int specialisationId);
