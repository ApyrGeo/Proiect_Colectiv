...
public class UserServiceTests
{
    ...
    {   
        ...
        _userService = new UserService(_mockUserRepository.Object, _mockMapper.Object, _validatorFactory, _mockPasswordHasher.Object, _mockEmailProvider.Object);
        ...
        string password, string role)
    {
        ...
        var userDTO = new UserPostDTO { FirstName = firstName, LastName = lastName, PhoneNumber = phone, Email = email, Password = password, Role = role };
        
        
        var userEntity = new User { FirstName = firstName, LastName = lastName, Email = email , Password = password , PhoneNumber = phone, Role =  Enum.Parse<UserRole>(role)};
        var userResponseDTO = new UserResponseDTO { Id = 1, FirstName = firstName, LastName = lastName, Email = email,  PhoneNumber = phone, Password = password, Role = role };
    ...
    public async Task GetUserByIdExistingUser(int id,string firstName, string lastName, string phone, string email,
        string password, string role)
    {
        var user = new User { Id = id,  FirstName = firstName, LastName = lastName, Email = email , Password = password , PhoneNumber = phone, Role =  Enum.Parse<UserRole>(role)};
        var userDto = new UserResponseDTO { Id = id,  FirstName = firstName, LastName = lastName, PhoneNumber = phone, Email = email, Password = password, Role = role };
